...
class InferenceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                ...
                response_deserializer=ai__service__pb2.PredictReply.FromString,
                )
...
def add_InferenceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Predict': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=ai__service__pb2.PredictReply.SerializeToString,
            ),
    }
...
class Inference(object):
    ...
    def Predict(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/inference.Inference/Predict',
            ...
            ai__service__pb2.PredictReply.FromString,
