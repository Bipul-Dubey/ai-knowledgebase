...
const (
	Inference_Predict_FullMethodName = "/inference.Inference/Predict"
)
...
func (c *inferenceClient) Predict(ctx context.Context, in *PredictRequest, opts ...grpc.CallOption) (*PredictReply, error) {
...
func (UnimplementedInferenceServer) Predict(context.Context, *PredictRequest) (*PredictReply, error) {
